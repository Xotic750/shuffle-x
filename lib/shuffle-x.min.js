 ...
 * @module shuffle-x
 */
"use strict";var slice=_dereq_("array-slice-x"),isString=_dereq_("is-string");module.exports=function shuffle(array){for(var obj=isString(array)?array.split(""):slice(array),i=obj.length;i;){var rnd=Math.floor(Math.random()*i),tmp=obj[i-=1];obj[i]=obj[rnd],obj[rnd]=tmp}return obj}},{"array-slice-x":2,"is-string":11}],2:[function(_dereq_,module,exports){/**
