 ...
 * @module shuffle-x
 */
"use strict";var toObject=_dereq_("to-object-x"),slice=_dereq_("array-slice-x");module.exports=function shuffle(array){for(var object=toObject(array),arr=slice(object),index=arr.length;index>0;){var rnd=Math.floor(Math.random()*index),tmp=arr[index-=1];arr[index]=arr[rnd],arr[rnd]=tmp}return arr}},{"array-slice-x":2,"to-object-x":22}],2:[function(_dereq_,module,exports){/**
